...
Force fields containing parameters for both small organic molecules and biopolymers are key deliverables on our long term roadmap. Since these developments will depend on scientific breakthroughs, much of the work is outside the scope of the OpenFF Consortium and is being conducted in academic labs within the OpenFF Initiative. 

As of 2025, a protein force field is in active development in the [Gilson lab at UCSD](https://gilson.cloud.ucsd.edu/). An [experimental version](https://github.com/openforcefield/openff-forcefields/releases/tag/2025.10.1) of the force field is available, and we've demonstrated its use in our [prototype workflow for parameterizing post-translationally modified proteins](https://github.com/openforcefield/ptm_prototype). Initial work toward developing a lipid force field is being conducted in the [Shirts lab at CU Boulder](https://www.colorado.edu/lab/shirtsgroup/). 
